...
$lang["logout"] = "logout";
$lang['con_err'] = 'read config err.';
$lang['db_err'] = 'web is maintenance.';
$lang['common_add'] = 'add';
$lang["no_access"] = "you have no right to do this.";
$lang["common_upload"] = "upload";
$lang["import_err"] = "import failed.";
$lang["import_check"] = "import failed. you should check data, here is list of their CODE";
$lang["import_msg"] = "import success.";
$lang["common_account_number_duplicate"] = "This account number is already present in the database";
$lang["no-select"] = "Not select";
$lang["company_title"] = "Please input company name";
$lang["common_update"] = "update";
$lang["common_confirm_delete"] = "Are you sure you want to delete the selected datas?";
$lang["common_company_name"] = "Company name";
$lang["common_none_selected"] = "You have not selected any data to delete";
